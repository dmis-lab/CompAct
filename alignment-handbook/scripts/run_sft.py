...
from evaluate_utils import compute_complete_metrics
...
def main():
    ...
    train_datasets = load_dataset("json", data_files=train_file_path)
    eval_datasets = load_dataset("json", data_files=test_file_path)
    ...
    eval_dataset = eval_datasets['train']
    ...
    trainer = SFTTrainer(
        ...
        peft_config=get_peft_config(model_args),
        dataset_kwargs=training_args.dataset_kwargs,
        # compute_metrics=compute_complete_metrics,
    )
